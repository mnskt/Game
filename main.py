...
while is_running:
    ...
    if screen.bg_img_front_offset <= -SCREEN_WIDTH:
        screen.bg_img_front_offset = SCREEN_WIDTH
    elif screen.bg_img_front_offset >= SCREEN_WIDTH:
        screen.bg_img_front_offset = -SCREEN_WIDTH
    if screen.bg_img_mid_offset <= -SCREEN_WIDTH:
        screen.bg_img_mid_offset = 0
    elif screen.bg_img_mid_offset >= SCREEN_WIDTH:
        screen.bg_img_mid_offset = 0
    if screen.bg_img_back_offset <= -SCREEN_WIDTH:
        screen.bg_img_back_offset = 0
    elif screen.bg_img_back_offset >= SCREEN_WIDTH:
        screen.bg_img_back_offset = 0
    ...
    if screen.att_anim_counter >= 40:
        screen.att_anim_counter = 0
        knight.action = 0
